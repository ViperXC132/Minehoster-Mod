...
public final class MinehosterScreen extends Screen {
    ...
    @Override public boolean keyPressed(KeyInput input){
        if(input.isEscape()){client.setScreen(parent);return true;}
        if(input.isEnter()&&commandBox!=null&&commandBox.isFocused()){sendCommand();return true;}
